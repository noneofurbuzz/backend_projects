...
export function Form(){
    ...
    return(
        ...
        <form className={`font-host grayscale-0 bg-white rounded-xl w-full  py-8 px-6 flex  flex-col`} onSubmit={handleSubmit}>
            ...
            <input  autoComplete = "off" className=" border-[1px] border-[#D9D9D9] input-shadow mb-[1.5rem] rounded-lg h-10 px-3 text-base w-full" placeholder="Name" name="name"/>
            <label htmlFor="message" className="text-[0.94rem] mb-2 leading-[2.4rem] ">Message</label>
            <textarea autoComplete = "off" placeholder="Message" name="message" rows = {6} className=" px-3 input-shadow text-base w-full py-[10px] border-[1px] rounded-lg border-[#D9D9D9]"></textarea>
